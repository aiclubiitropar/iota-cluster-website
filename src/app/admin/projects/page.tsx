              ...
              return (
                <div key={p.id} className={styles.listItem} style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                  ...
                  <div style={{ display: 'flex', gap: '0.5rem', flexShrink: 0, marginLeft: '1rem' }}>
                    <Link href={`/admin/projects?edit=${p.id}`} className="p-2 bg-[var(--glass-bg)] border border-[var(--glass-border)] rounded hover:bg-[var(--accent-purple)] transition text-sm flex items-center justify-center text-white" style={{ textDecoration: 'none' }}>
                      Edit
                    </Link>
